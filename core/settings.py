...
ALLOWED_HOSTS = ['https://kushyadav1997.pythonanywhere.com/']
...
MIDDLEWARE = [
    ...
    'core.middleware.LoginRequiredMiddleware',    # custom middleware used for global login
]
...
# Where to collect static files (collectstatic will dump files here)
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')

# Where to find your custom static files (during dev)
STATICFILES_DIRS = [
